...
$filePrice = \Bitrix\Main\Config\Option::get( "askaron.settings", "UF_PRICE_FILE");
?>
    ...
    <div class="catalog__content">
        ...
        <?php if ($showBottomPager): ?>
		    <div class="catalog__navigation">
	            <?= $arResult['NAV_STRING']; ?>
				<?php if (strpos($url, '/property-sales/realizatsiya-tmts/') !== false && $filePrice): ?>
					<a href="<?= CFile::GetPath($filePrice); ?>" class="catalog__downloaded" target="_blank" style='--icon:url("<?= SITE_TEMPLATE_PATH; ?>/assets/static/img/icons/10.svg")' download>Скачать полный перечень товаров</a>
				<?php endif; ?>
		    </div>
        <?php endif; ?>
    </div>
