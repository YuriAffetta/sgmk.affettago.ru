...
$APPLICATION->SetTitle("Реализация имущества");

if ($APPLICATION->GetCurPage() === '/property-sales/') {

    header("Location: /property-sales/realizatsiya-transporta-i-oborudovaniya/");
}
?>
